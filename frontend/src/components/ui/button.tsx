...
const base =
  "relative inline-flex items-center justify-center gap-2 rounded-lg overflow-hidden whitespace-nowrap font-sans font-medium " +
...
const variants: Record<Variant, string> = {
  primary: "group bg-accent text-white hover:bg-accent-deep",
